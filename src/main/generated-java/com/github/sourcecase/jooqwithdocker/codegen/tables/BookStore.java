...
public class BookStore extends TableImpl<BookStoreRecord> {
    ...
    private static final long serialVersionUID = -641941508;
    ...
    public List<UniqueKey<BookStoreRecord>> getKeys() {
        return Arrays.<UniqueKey<BookStoreRecord>>asList(Keys.KEY_BOOK_STORE_PRIMARY, Keys.KEY_BOOK_STORE_NAME);
    }
